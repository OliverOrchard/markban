...
{
    [Fact]
    public void Routes_ContainsAllSixteenRoutes()
    {
        CommandRouter.Routes.Should().HaveCount(16,
            because: "there are sixteen CLI commands routed through the strategy pattern");
    }
